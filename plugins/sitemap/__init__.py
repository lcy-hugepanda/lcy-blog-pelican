...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <link rel="web-socket" href="wss://live.github.com/_sockets/NTg0MjY2Njo1NmJlYmI4OGNlYjNjOThjMTkyYTgzNTk1ZDUwZTgyZTo0NDFjNmQ0NWY1NDdiMGJhZTQ1N2VjZDg5ZTgzNWJlMGMxODE2NzhkOTNjYWVlYTNkMzcxZDllYzgzNzAzODky--9658968b10cedc397f9a17a9f371b8cb39836af4">
...
<meta content="z2LrzzgnMFBh6TrSRP61EKYVmNsO5obQohDxeJWcMCmtEPfBOoYWA7QQXyG0TC5ajPQKeBss/qiTqKPkCQF/ZQ==" name="csrf-token" />
...
<li>
  ...
  <li class="header-nav-item">
    <form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="DOvo1y3xuBySPHmCVY1jKkMLiCoypKgDLHN2nzNbUHhjobUAO5B1AAepiPI1hymcKeDMi9I4sj3famgdL8QWmQ==" /></div>
...
<ul class="pagehead-actions">
  ...
  <li>
      <form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="GYxmPQU1ZxQiRsRfi8mY0fQUAjtf3wBjQHyuwKTRGoEJdGMnMEPi91r4XiWNJ3EzG5fzHlZag/LPJjr80JYS7Q==" /></div>    <input id="repository_id" name="repository_id" type="hidden" value="6547965" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <form accept-charset="UTF-8" action="/getpelican/pelican-plugins/unstar" class="js-toggler-form starred js-unstar-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="Wi1XGTetXCmQ+tSiZCqEIbI3r2DZRJGOFhnNXpB9X1z/aJAFWGBELqk/uFEPF8As7HXWZSTOCpwPQ5VQbLyUpQ==" /></div>
      <button
    ...
    <form accept-charset="UTF-8" action="/getpelican/pelican-plugins/star" class="js-toggler-form unstarred js-star-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="8CBPs1DvK/V0xhMwVu8b6zm4602N/U/YPnGH6RrKhk1aVx8rWFWAzzb8SLhRa9328vc0//7FTgvynq43Zi5niQ==" /></div>
      <button
        class="btn btn-sm btn-with-count js-toggler-target"
...
<a href="/getpelican/pelican-plugins/blob/4421bfd40625734f45b451411f43769b6aa9ce60/sitemap/__init__.py" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:15145af0b4ed701b879e144152b01eb5 -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/getpelican/pelican-plugins/blob/master/sitemap/__init__.py"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/getpelican/pelican-plugins/blob/touch/sitemap/__init__.py"
               data-name="touch"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
...
<include-fragment class="commit commit-loader file-history-tease" src="/getpelican/pelican-plugins/contributors/master/sitemap/__init__.py">
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/getpelican/pelican-plugins/raw/master/sitemap/__init__.py" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/getpelican/pelican-plugins/blame/master/sitemap/__init__.py" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/getpelican/pelican-plugins/commits/master/sitemap/__init__.py" class="btn btn-sm " rel="nofollow">History</a>
      </div>

        <a class="octicon-btn tooltipped tooltipped-nw"
           href="github-windows://openRepo/https://github.com/getpelican/pelican-plugins?branch=master&amp;filepath=sitemap%2F__init__.py"
           aria-label="Open this file in GitHub for Windows">
            <span class="octicon octicon-device-desktop"></span>
        </a>

            <form accept-charset="UTF-8" action="/getpelican/pelican-plugins/edit/master/sitemap/__init__.py" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="QWmyGAYHUz5WtnLgR8TBFyaYa9F3PDwyMDHHlAoKtpNPyTc9HC8hHPvrq8g6gG5m8Ye/CvthUHzCO1ZByilAXA==" /></div>
          ...
          <form accept-charset="UTF-8" action="/getpelican/pelican-plugins/delete/master/sitemap/__init__.py" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="xBwQKlzRUNeXZijEhWexE5FHgCNOv4a4v8jXCCepdJL4r7CL3fPgAFYEcyRcvFSOhqj+kjJeaBXLPcrwaGTQ4g==" /></div>
  ...
  <div class="blob-wrapper data type-python">
      ...
      <tr>
        ...
        <td id="LC1" class="blob-code js-file-line"><span class="pl-k">from</span> .sitemap <span class="pl-k">import</span> <span class="pl-k">*</span></td>
      </tr>
</table>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.06367s from github-fe139-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
