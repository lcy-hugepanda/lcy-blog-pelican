...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <link rel="web-socket" href="wss://live.github.com/_sockets/NTg0MjY2Njo1NmJlYmI4OGNlYjNjOThjMTkyYTgzNTk1ZDUwZTgyZTplMWUxNzg5ZDNmMTc0ZmNiODNjYjYyODM1YmE3YzMzNGQyN2M5YTQyYmRiZDliN2MzYjExMGUwMmQzMzQyNTlm--56fdcdb926d9ff9699cde788b8a7388f361c18fb">
...
<meta content="voQDdiQaa0XgLeO/FeE0kh3val7r6iSC9UpOY1k69vRG+MYLp/YTxv8HWUps9AgbN6WO0aFBkclLUt1cSSCNdg==" name="csrf-token" />
...
<li>
  ...
  <li class="header-nav-item">
    <form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="CH0qHZ0UpEJjruI9pSIZSwZW+G2FOPN1G203UlfxtUjpTKjskpNFqsCl91SUTQVXQoPJipJzvpGVXtBOY8cBFw==" /></div>
...
<ul class="pagehead-actions">
  ...
  <li>
      <form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="6BWSQ0KVTGKtfQdNjfakUU38jSSvX1+x9bGyFCAZYlgjneZOD10vvfPrOhnuGFT12nxjmZLP8gEX/+8maOfYGw==" /></div>    <input id="repository_id" name="repository_id" type="hidden" value="6547965" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <form accept-charset="UTF-8" action="/getpelican/pelican-plugins/unstar" class="js-toggler-form starred js-unstar-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="a+nkQUExWVNbkyR5rNW5LJtoKb5hRI2yBL7+SkqhPwJJKCxfu4wMoepyFNQgygnvuMQhn+n9WC8ehU4cjS8vQQ==" /></div>
      <button
    ...
    <form accept-charset="UTF-8" action="/getpelican/pelican-plugins/star" class="js-toggler-form unstarred js-star-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="7TAXcZGfXBz/BVjcHRJi7yXLcDZjSrHdlNOEG8glEa5WTP6HgR4Sj4eerHKnS3LBxjx8qtCMmbrnoGZr7mL/Nw==" /></div>
      <button
        class="btn btn-sm btn-with-count js-toggler-target"
...
<a href="/getpelican/pelican-plugins/blob/4421bfd40625734f45b451411f43769b6aa9ce60/extract_toc/__init__.py" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:77523c6648a9ed13a9b192bbcaf422c7 -->
...
<div class="select-menu js-menu-container js-select-menu left">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/getpelican/pelican-plugins/blob/master/extract_toc/__init__.py"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/getpelican/pelican-plugins/blob/touch/extract_toc/__init__.py"
               data-name="touch"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
  ...
  <div class="commit file-history-tease">
    <div class="file-history-tease-header">
        <img alt="@talha131" class="avatar" data-user="1094724" height="24" src="https://avatars2.githubusercontent.com/u/1094724?v=3&amp;s=48" width="24" />
        <span class="author"><a href="/talha131" rel="contributor">talha131</a></span>
        <time datetime="2013-04-16T17:29:57Z" is="relative-time">Apr 16, 2013</time>
        <div class="commit-title">
            <a href="/getpelican/pelican-plugins/commit/45b30942475c090e8af4c279b0570ec19b79c34a" class="message" data-pjax="true" title="Adds Extract table of contents plugin">Adds Extract table of contents plugin</a>
        </div>
    </div>
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/getpelican/pelican-plugins/raw/master/extract_toc/__init__.py" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/getpelican/pelican-plugins/blame/master/extract_toc/__init__.py" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/getpelican/pelican-plugins/commits/master/extract_toc/__init__.py" class="btn btn-sm " rel="nofollow">History</a>
      </div>

        <a class="octicon-btn tooltipped tooltipped-nw"
           href="github-windows://openRepo/https://github.com/getpelican/pelican-plugins?branch=master&amp;filepath=extract_toc%2F__init__.py"
           aria-label="Open this file in GitHub for Windows">
            <span class="octicon octicon-device-desktop"></span>
        </a>

            <form accept-charset="UTF-8" action="/getpelican/pelican-plugins/edit/master/extract_toc/__init__.py" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="DddwjCE9t8iH2Wj96LCDKaLhQbydT5DrvVM1iq3sf42qAQkmPCmcoD00maVV+CGQsSe2gvGjn3PFrPXmYRJFuA==" /></div>
          ...
          <form accept-charset="UTF-8" action="/getpelican/pelican-plugins/delete/master/extract_toc/__init__.py" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="1wEum9yp8W83I0up+sZlKrc8o8zjV3HeOdhHGp52Rn8azlpQeBhyR2OZVPFYytm/kESdy0LBsLoq9DcwmOewQA==" /></div>
  ...
  <div class="blob-wrapper data type-python">
      ...
      <tr>
        ...
        <td id="LC1" class="blob-code js-file-line"><span class="pl-k">from</span> .extract_toc <span class="pl-k">import</span> <span class="pl-k">*</span></td>
      </tr>
</table>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.05028s from github-fe121-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
